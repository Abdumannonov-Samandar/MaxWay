          ...
          <div className="flex justify-between items-center max-w-[1091px] mx-auto">
            ...
            <nav className="hidden md:flex items-center gap-20">
              <ul className="flex items-center gap-10">
                <li>
                  <a
                    className="text-sm font-normal text-[#222124] group relative w-max"
                    href="#"
                  >
                    <span>Menyu</span>
              ...
              <ul className="flex items-center gap-10">
                <li className="flex items-center gap-4">
                  <img className="w-6 h-6" src={Call} alt="tell" />
                ...
                <li className="flex items-center gap-[6px] relative">
                    <img className="w-[32px] h-[34px]" src={Shop} alt="shop img" />
                    {prices.length > 0 && (
